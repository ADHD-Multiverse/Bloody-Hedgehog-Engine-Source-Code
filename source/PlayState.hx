...
class PlayState extends MusicBeatState
{
	...
	private var score:AttachedSprite;
	private var miss:AttachedSprite;
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("NiseSegaSonic.TTF"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		healthBarOVERLAY = new AttachedSprite('healthBarOVER');
		healthBarOVERLAY.y = FlxG.height * 0.85;
		...
		score = new AttachedSprite('score');
		score.x = 85.5;
		score.y = 48.15;
		score.scale.set(3.8, 3.8);
		score.scrollFactor.set();
		score.visible = !ClientPrefs.hideHud;
		add(score);

		scoreTxt = new FlxText(180, 35, FlxG.width - 800, "", 37);
		scoreTxt.setFormat(Paths.font("sonic.ttf"), 37, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scoreTxt.scale.set(37, 37);
		scoreTxt.scrollFactor.set();
		scoreTxt.borderSize = 1.25;
		scoreTxt.visible = !ClientPrefs.hideHud;
		add(scoreTxt);

		miss = new AttachedSprite('misses');
		miss.x = 95.5;
		miss.y = 178.15;
		miss.scale.set(3.8, 3.8);
		miss.scrollFactor.set();
		miss.visible = !ClientPrefs.hideHud;
		add(miss);

		missesTxt = new FlxText(180, 160, FlxG.width - 800, "", 37);
		missesTxt.setFormat(Paths.font("sonic.ttf"), 37, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		missesTxt.scale.set(37, 37);
		...
		botplayTxt.setFormat(Paths.font("NiseSegaSonic.TTF"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	{
		curHealth = FlxMath.lerp(curHealth, health, .2 / (ClientPrefs.framerate / 60));
